              ...
              <div className="p-6">
                ...
                <div className="mt-6 flex gap-3">
                  <motion.button
                    ...
                    onClick={() => navigate(`/course/${course.id}`)}
                    className="flex-1 rounded-2xl border border-indigo-500 bg-white dark:bg-zinc-900 px-5 py-3 text-sm font-semibold text-indigo-600 transition-all hover:bg-indigo-50 dark:hover:bg-zinc-800"
                  >
                    View Course
                  </motion.button>
                  ...
                  <motion.button
                    ...
                    onClick={() => setSelectedCourse(course)}
                    className="flex-1 rounded-2xl bg-gradient-to-r from-indigo-500 to-violet-600 px-5 py-3 text-sm font-semibold text-white"
                  >
                    Book Now →
                  </motion.button>
                </div>
